...
type GuestRegisterRequest struct {
	Username string `json:"username" form:"username" from:"username" binding:"required,min=3" example:""`
	Password string `json:"password" form:"password" from:"password" binding:"required,min=3" example:""`
	Name     string `json:"name" form:"name" from:"name" binding:"required,min=3" example:""`
}
